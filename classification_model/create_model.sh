...
$PYTHON_PATH ${SCRIPT_DIR}/prepare_file.py ${TARGET_PATH}/tmp/base_input_${CLASSIFICATION}.tsv.gz ${FEATURES_PATH} ${TARGET_PATH}/tmp/prepared_data_${CLASSIFICATION}.tsv.gz
